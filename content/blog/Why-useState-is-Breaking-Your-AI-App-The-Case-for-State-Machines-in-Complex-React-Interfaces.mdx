...
Before we dive into solutions, let's be clear about what we're building. What seems like a simple "type a prompt, get a response" feature actually has **real-world challenges** that break simple state management:
...
#### The Real Challenges (Not Mocked Timers)
