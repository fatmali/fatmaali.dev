          ...
          <div className="grid grid-cols-1 gap-12 items-center max-w-4xl mx-auto">
            ...
            >
              <p className="text-muted-foreground mb-6">
                As a passionate Frontend Engineer with expertise in building
                modern web applications, I thrive on creating intuitive,
                accessible, and beautiful user interfaces. My journey in tech
                began with a curiosity about how digital experiences shape our
                daily lives.
              </p>
              <p className="text-muted-foreground mb-6">
                I specialize in React, TypeScript, and Next.js, focusing on
                performance optimization and responsive design. My approach
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:hello@fatmaali.dev"
                  ...
                  <div className="flex space-x-4">
                    {[
                      ...
                      },
                      {
                        ...
                        url: "https://www.linkedin.com/in/fatmaali/"
                      },
                      {
                        name: "Medium",
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-lg border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all">
                    <option value="" disabled defaultValue="collaboration">
                      Select a subject
                    </option>
